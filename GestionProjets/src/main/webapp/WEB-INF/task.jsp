    ...
    <div class="elementor-container">
        <form action="/GestionProjets/TaskController" method="post">
            <table border="1">
                <tr>
                    <td>Task Code:</td>
                    <td><input type="text" name="taskCode" value="${model.task.taskCode}" placeholder="Task Code"/></td>
                </tr>
                <tr>
                    <td>Task Description:</td>
                    <td><input type="text" name="taskDescription" value="${model.task.taskDescription}" placeholder="Task Description" /></td>
                </tr>
                <tr>
                    <td>Start Date:</td>
                    ...
                    <td>
                        <select name="selectedProjectCode">
                            <c:forEach var="project" items="${requestScope.projects}">
                                <option value="${project.code}" ${project.code eq model.task.project.code ? 'selected' : ''}>${project.code}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="submit" name="action" value="List Of Tasks" /></td>
                </tr>
            </table>
        </form>
    </div>
